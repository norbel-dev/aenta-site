...
@section('title', $item->exists ? 'Edit Header' : 'Create Header')

@section('content_header')
    <h1>{{$item->exists ? 'Edit Header' : 'Create Header'}}</h1>
@endsection
...
<div class="container">
    ...
    @endif
    <form method="POST"
          action="{{ $item->exists ? route('admin.headers.update', $item) : route('admin.headers.store') }}"
